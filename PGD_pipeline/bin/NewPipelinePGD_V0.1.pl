        ...
        if($QuaSym == 1){
         ...
         #      print OUT "\n";
           foreach $_(@num){
                ...
                print OUT "/hwfssz1/ST_MCHRI/REHEAL/USER/chendayang/00.rawdata/ifs1/bin/PGD/soft/jre1.8.0_121/bin/java -jar $picard/SortSam.jar I=$Out/temp_$_.bam  O=$Out/temp_$_.bam.sort.picard.bam SO=coordinate VALIDATION_STRINGENCY=SILENT\n";
